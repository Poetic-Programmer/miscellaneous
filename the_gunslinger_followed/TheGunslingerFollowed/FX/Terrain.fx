...
VertexOut VS(VertexIn vin)
{
	...
	vout.PosW.y = gHeightMap.SampleLevel( samHeightmap, vin.Tex, 0 ).r + (gHeightMapOffset.SampleLevel( samHeightmap, vin.Tex, 0 ).r * gScaleValue);
             ...
             const OutputPatch<HullOut, 4> quad)
{
	...
	offset.y = gHeightMapOffset.SampleLevel( samHeightmap, dout.Tex, 0 ).r * gScaleValue;
	
	dout.PosW.y = gHeightMap.SampleLevel( samHeightmap, dout.Tex, 0 ).r + offset.y;  
