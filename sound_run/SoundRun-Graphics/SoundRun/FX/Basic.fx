...
VertexOut VS(VertexIn vin)
{
	...
	vout.Tex = mul(float4(vin.Tex, 0.0f, 1.0f), gTexTransform).xy;vout.Tex.y = vin.Tex.y + gTexScrollSpeed;
	//vout.Tex.y = vin.Tex.y + (gFrameTime * gTexScrollSpeed);
