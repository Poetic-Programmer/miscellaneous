...
public:
	...
	void SetFrameTime(const float time)                 { FrameTime->SetFloat(time); }
	void SetTextureScrollSpeed(const float s)           { TextureScrollSpeed->SetFloat(s); }
	...
	ID3DX11EffectScalarVariable* TextureScrollSpeed;
